...
export const metadata: Metadata = {
  title: 'Marine Risk Advisory',
  description:
    'Structured risk advisory, insurance placement, and claims advocacy for maritime operations, cargo, hull, and offshore facilities.',
}
...
const capabilities: IconCard[] = [
  ...
  { icon: FileText, title: 'Offshore Operations', desc: 'Offshore construction all risks, installation floater, and marine warranty for capital-intensive offshore exploration and energy projects.' },
]
    ...
    <>
        ...
        <div className="container-page grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          <FadeIn>
            ...
            <div className="mt-6 space-y-4 text-sm leading-relaxed text-muted-foreground">
              <p>
                Maritime operations span a uniquely broad risk spectrum — from the physical exposure
                of vessels navigating international waters to the complex liability frameworks
                governing cargo, crew, and third-party interests under conventions such as the
                Hague-Visby Rules, CLC, and MARPOL. Effective marine insurance demands both technical
              ...
              <p>
                ...
                capacity to respond appropriately when they do.
              </p>
              <p>
                Whether your exposure is a single voyage, a managed fleet, a bulk cargo programme, or
                an offshore installation project, we structure coverage that reflects the actual risk
                profile of your operations — and advocate robustly on your behalf when claims arise.
              </p>
            </div>
          </FadeIn>
          <FadeIn delay={0.15}>
            <Image
              src="/images/industry-marine.jpg"
      ...
      <section className="relative isolate overflow-hidden py-20 text-white md:py-28">
        <div className="absolute inset-0 -z-10">
          <Image src="/images/industry-marine.jpg" alt="" fill className="object-cover" sizes="100vw" />
        ...
        <div className="container-page">
          <FadeIn className="max-w-2xl">
            ...
            <p className="mt-4 text-sm text-muted-foreground">
              We engage specialist marine markets to structure programmes that address the real
              exposure profile of your operations — not off-the-shelf wordings applied without
              context.
            </p>
          </FadeIn>
