...
import heroImg from "@/assets/industry-aviation.jpg";
import aviationImg from "@/assets/industry-aviation.jpg";

export const Route = createFileRoute("/industries/aviation")({
  head: () => ({
    meta: [
      { title: "Aviation Risk Advisory | AIB" },
      { name: "description", content: "Structured risk advisory, insurance placement, and claims advocacy for airlines, operators, airports, and aerospace organisations." },
    ],
  }),
...
const cards = [
  {
    ...
    desc: "Strict ICAO regulatory compliance, high-value fleet assets, multi-jurisdictional third-party liability exposure, demanding maintenance obligations, and significant reputational risk following any incident.",
  },
  {
    icon: AlertTriangle,
    title: "Risk Environment",
    desc: "Hull damage and total loss, passenger liability, third-party bodily injury and property damage, product liability, airport operational exposure, and MRO and ground handling risk.",
  },
  {
    icon: Users,
    title: "AIB Approach",
    desc: "Structured aviation programme design covering hull, liability, and ancillary coverages, with specialist market access and proactive claims advocacy support from notification through to settlement.",
  },
  {
    icon: Award,
    title: "Market Capability",
    desc: "Access to leading aviation insurance markets including Lloyd's dedicated aviation syndicates and international underwriters with capacity for commercial, charter, and general aviation operations.",
  },
];
...
function AviationPage() {
  return (
    <>
      <PageHero
        eyebrow="Aviation"
        title={<>Managing Technical and Liability<br />Risk in Aerospace Operations.</>}
        ...
        <div className="container-page grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <FadeIn>
            ...
            <div className="mt-6 space-y-4 text-muted-foreground text-sm leading-relaxed">
              <p>
                Aviation is one of the most technically regulated and liability-sensitive industries in the world. The combination of high-value assets, complex multi-jurisdictional legal frameworks, and public-facing operations means that gaps in insurance coverage — or coverage that isn't properly structured — can have catastrophic financial consequences.
              </p>
              <p>
                AIB's aviation practice works with commercial airlines, charter and business aviation operators, airports, MRO providers, and aerospace organisations to design and place insurance programmes that genuinely reflect the risk profile of their operations. We engage dedicated aviation underwriters — not generalist markets — with the technical knowledge to assess your exposure accurately and provide capacity on appropriate terms.
              </p>
              <p>
                Our involvement extends beyond placement. When losses occur in aviation, claims can be complex, contested, and prolonged. We provide active claims advocacy — managing the process, engaging loss adjusters, and pressing for equitable outcomes aligned with the policy terms we helped negotiate.
              </p>
            </div>
          </FadeIn>
          <FadeIn delay={0.15}>
            <img src={aviationImg} alt="Aviation operations" className="rounded-sm object-cover w-full h-80 lg:h-96 shadow-md" loading="lazy" />
          </FadeIn>
        </div>
      </section>
      ...
      <section className="bg-white py-20 md:py-24">
        <div className="container-page">
          <FadeIn className="max-w-2xl">
            ...
            <p className="mt-4 text-muted-foreground text-sm">From commercial fleet operations to airports and MRO facilities, we structure coverage designed specifically for the regulatory and operational realities of your aviation activities.</p>
          </FadeIn>
